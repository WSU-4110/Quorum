...
namespace QuorumUnit
{
    ...
    public class CounterCSharpTests : TestContext
    {
        ...
        {
            string input = @"![bug](https://64.media.tumblr.com/a173ece72bab1e6648c99ad4162eb046/tumblr_pw9hldCvv31us4qppo3_r1_500.gif){width=128 height=128}";

            //Can add a service regularly 
            Services.AddSingleton<IHtmlSanitizer, HtmlSanitizer>();

            var cut = RenderComponent<Markdown>(Parameter("InputText", input));
            cut.Find("p").MarkupMatches(@"<p><img src=""https://64.media.tumblr.com/a173ece72bab1e6648c99ad4162eb046/tumblr_pw9hldCvv31us4qppo3_r1_500.gif"" width=""128"" height=""128"" alt=""bug""></p>");
        }
    }
}
